...
class Motor_control(Node):
    def __init__(self):
        ...
        self.motor_map = {
            ...
            "/lower_arm_right_rotation": 3,
            "/wrist_right": 4,
            #shoulder_vertical_right uses 2 motors thus if msg recieved to move this joint, value is sent to two motors (5,8) 
            "/shoulder_horizontal_right": 6,
            #/shoulder_vertical_left uses 2 motors thus if msg recieved to move this joint, value is sent to two motors (7,9) 
        }
